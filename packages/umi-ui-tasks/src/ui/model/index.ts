...
export default {
  ...
  effects: {
    ...
    *init({ payload, callback }, { call, put }) {
      const { currentProject, getSharedDataDir } = payload.api;
    ...
    *getTaskDetail({ payload }, { put, call }) {
      const { taskType, callback, log, stats, dbPath } = payload;
      const result = yield call(getTaskDetail, taskType, log, stats, dbPath);
